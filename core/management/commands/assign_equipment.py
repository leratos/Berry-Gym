...
from core.models import Uebung, Equipment, EQUIPMENT_CHOICES
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        equipment_keywords = {
            'LANGHANTEL': ['langhantel', 'barbell', 'squat', 'kreuzheben', 'deadlift', 'frontdrücken'],
            ...
            'KOERPER': ['push-up', 'liegestütz', 'burpee', 'mountain climber', 'wandsitz', 'ausfallschritt'],
        }
