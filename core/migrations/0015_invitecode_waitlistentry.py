    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=20, unique=True, verbose_name="Einladungscode"),
                ),
                (
                    "max_uses",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.TextField(
                        help_text="Warum möchtest du HomeGym nutzen?", verbose_name="Motivation"
                    ),
                ),
                (
                    "experience",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status", "created_at"], name="core_waitli_status_9a681c_idx"
                    ),
                    models.Index(fields=["email"], name="core_waitli_email_4321a2_idx"),
                ],
            },
        ),
    ]
